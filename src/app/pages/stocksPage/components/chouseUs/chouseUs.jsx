                    ...
                    <div className="desk_view">
                        ...
                        <div className="row">
                            <div className="col-md-8">
                                ...
                                <a className="stocks_chouseUs__btn stocks_chouseUs__btn--download lg-btn" href="https://trade.a-book.com/en/sign-up" style={{ padding: "16px 40px" }}>{langTokens.BTN_DOWNLOAD}</a>
