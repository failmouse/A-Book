            ...
            <div className="row" style={{ "alignItems": "center" }}>
                <div className="col-md-6 left_side">
                    ...
                    <ul className="list-unstyled">
                        ...
                        <li><span><b>{langTokens.FOREX_LIST_ITEM6_BOLD} </b><a href="https://trade.a-book.com/en/sign-up">{langTokens.FOREX_LIST_ITEM6_HREF}</a> {langTokens.FOREX_LIST_ITEM6_MAIN}</span></li>
                    ...
                    <div className="center indent__list indent__btn">
                        <a className="choose_best__btn choose_best__btn--start md-btn" href="https://trade.a-book.com/en/sign-up">{langTokens.FOREX_LIST_BTN_START}</a>
                    </div>
                </div>
                    ...
                    <div className="panel">
                        ...
                        {crypto.map((i, index) =>
                            <div className="row stroke" key={index}>
                                ...
                                <div className="col-md-3 d-none d-md-block mobile_view"><a className={`btn-Crypto btn-Crypto--create sm-btn ${selectedLang === 'ru' ? "md-btn" : ""}`} href="https://trade.a-book.com/en/sign-up">{langTokens.CRYPTO_TOP_PANEL_BTN_SELL}</a></div>
                            </div>)}
