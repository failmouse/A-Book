        ...
        <div className='container'>
            <div className='row banner_desk'>
                <div className='col-md-7 col-lg-8'>
                    <h1 className='indent__title_auxilary'>{langTokens.COMMODITIES_BANNER_TITTLE}</h1>
                    <ul className='list-unstyled desk_ul indent__list'>
                        <li>{langTokens.COMMODITIES_BANNER_LIST_ELEMENT_1}</li>
                        <li>{langTokens.COMMODITIES_BANNER_LIST_ELEMENT_2}</li>
                        <li>{langTokens.COMMODITIES_BANNER_LIST_ELEMENT_3}</li>
                        <li>{langTokens.COMMODITIES_BANNER_LIST_ELEMENT_4}</li>
                        {/* <li>{langTokens.COMMODITIES_BANNER_LIST_ELEMENT_5}</li>
            ...
            <div className='mobile'>
                ...
                {/* <div className='stocks_benefits'>
                    <div className='stocks_benefits__item'>
                        ...
                        <h2>{langTokens.COMMODITIES_BANNER_MOBILE_BENEFIT_ITEM_TITTLE}</h2>
                        <p>{langTokens.COMMODITIES_BANNER_MOBILE_BENEFIT_ITEM_1}</p>
                    </div>
                    <div className='stocks_benefits__item'>
                        <img src={choice} alt='' width="36px" height="27px"/>
                        <h2>{langTokens.COMMODITIES_BANNER_MOBILE_BENEFIT_ITEM_2_TITTLE}</h2>
                        <p>{langTokens.COMMODITIES_BANNER_MOBILE_BENEFIT_ITEM_2}</p>
                    </div>
                    <div className='stocks_benefits__item'>
                        <img src={secure} alt='' className='customsvg' width="36px" height="27px"/>
                        <h2>{langTokens.COMMODITIES_BANNER_MOBILE_BENEFIT_ITEM_3_TITTLE}</h2>
                        <p>{langTokens.COMMODITIES_BANNER_MOBILE_BENEFIT_ITEM_3}</p>
                    </div>
                    <div className='stocks_benefits__item'>
                        <img src={support} alt='' className='customsvg' width="36px" height="27px"/>
                        <h2>{langTokens.COMMODITIES_BANNER_MOBILE_BENEFIT_ITEM_4_TITTLE}</h2>
                        <p>{langTokens.COMMODITIES_BANNER_MOBILE_BENEFIT_ITEM_4}</p>
                    </div>
                </div> */}
            </div>
        </div>
