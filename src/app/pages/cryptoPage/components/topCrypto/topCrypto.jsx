                ...
                <div className="panel">
                    <div className="names row">
                        ...
                        <ul className="list-unstyled body">
                            ...
                            <div className="col-md-3 mobile_view"><a className="btn-Crypto btn-Crypto--create" href="https://trade.stocksfinex.com/en/sign-up">{langTokens.CRYPTO_TOP_PANEL_BTN_BUY}</a></div>
                            </div>)}
                        </ul>
                </div>
            </div>
